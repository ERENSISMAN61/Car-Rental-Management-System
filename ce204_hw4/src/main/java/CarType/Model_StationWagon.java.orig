/**
 * @file Model_StationWagon.java
 * 
 * @package CarType
 * 
 * @brief A class representing a Station Wagon model car.
 * 
 * This class represents a specific type of car called Station Wagon. It implements the CarFeaturesInterface,
 * which provides methods to access various features of a car.
 * 
 * @details The `Model_StationWagon` class represents a specific type of car called Station Wagon. It is initialized
 * with the provided brand, model, car year, fuel type, color, price, and number of seats. These values are
 * used to set the corresponding attributes of the `Model_StationWagon` object.
 */
package CarType;
 ...
 * @brief A class representing a Station Wagon model car.
 */
public class Model_StationWagon implements CarFeaturesInterface {
	...
	/**
	 * 
	 * @name Model_StationWagon
	 * 
     * @brief Constructs a Station Wagon model car with the given parameters.
     * 
     ...
     * 
     **/
	public  Model_StationWagon(String brand, String model, int carYear, String fuelType, String color,int price, int seatsNumber) {
		this.brand = brand;
		this.model = model;
