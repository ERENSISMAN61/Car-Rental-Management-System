/**
 * @file Model_Sedan.java
 * 
 * @package CarType
 * 
 * @brief A class representing a Sedan model car.
 * 
 * This class represents a specific type of car called Sedan. It implements the CarFeaturesInterface,
 * which provides methods to access various features of a car.
 * 
 * @details The `Model_Sedan` class represents a specific type of car called Sedan. It is initialized
 * with the provided brand, model, car year, fuel type, color, price, and number of seats. These values are
 * used to set the corresponding attributes of the `Model_Sedan` object.
 */
package CarType;
 ...
 * @brief A class representing a Sedan model car.
 **/
public class Model_Sedan implements CarFeaturesInterface {
	 ...
	 * @name Model_Sedan
	 * 
     * @brief Constructs a Sedan model car with the given parameters.
     * 
     ...
     * 
     **/
	public  Model_Sedan(String brand, String model, int carYear, String fuelType, String color,int price, int seatsNumber) {
		this.brand = brand;
		this.model = model;
