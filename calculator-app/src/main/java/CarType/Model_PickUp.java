/**
 * @file Model_PickUp.java
 * 
 * @package CarType
 * 
 * @brief A class representing a PickUp model car.
 * 
 * This class represents a specific type of car called PickUp. It implements the CarFeaturesInterface,
 * which provides methods to access various features of a car.
 * 
 * @details The `Model_PickUp` class represents a specific type of car called PickUp. It is initialized
 * with the provided brand, model, car year, fuel type, color, price, and number of seats. These values are
 * used to set the corresponding attributes of the `Model_PickUp` object.
 */
package CarType;
 ...
 * @brief A class representing a PickUp model car.
 **/
public class Model_PickUp implements CarFeaturesInterface{
	 ...
	 * @name Model_PickUp
	 * 
     * @brief Constructs a PickUp model car with the given parameters.
     * 
     ...
     * 
     **/
	public  Model_PickUp(String brand, String model, int carYear, String fuelType, String color,int price, int seatsNumber) {
		this.brand = brand;
		this.model = model;
     ...
     * 
     * @retval The fuel type of the car.
     **/
	@Override
