...
public class Tests {
     ...
     */
	 ...
	 @Test
		...
		public void testRentalFactory() {
			CarFeaturesInterface car = RentalFactory.createCar("hatchback", "MERCEDESBENZ", "VITO", 2007, "GASOLINE", "GRAY", 261,
					4);
			assertEquals("MERCEDESBENZ", car.getBrand());
			assertEquals("VITO", car.getModel());
	...
	public void testCabrioGetBrand() {
		...
		CarFeaturesInterface car = rental.createCar("cabrio", "mercedes", "cla", 2021, "gasoline", "red", 2000, 4);
	...
	public void testPickUpkGetBrand() {
		RentalFactory rental = new RentalFactory();
		CarFeaturesInterface car = rental.createCar("pickup", "renault", "clio", 2023, "gasoline", "red", 2000, 4);
	...
	public void testSedanGetBrand() {
		RentalFactory rental = new RentalFactory();
		CarFeaturesInterface car = rental.createCar("sedan", "renault", "clio", 2023, "gasoline", "red", 2000, 4);
		assertEquals("renault", car.getBrand());
		assertEquals("clio", car.getModel());
		assertEquals(2023, car.getCarYear());
		assertEquals("gasoline", car.getFuelType());
	...
	public void testSedanGetBrand1() {
		RentalFactory rental = new RentalFactory();
		CarFeaturesInterface car = rental.createCar("sedan", "renault", "clio", 2021, "gasoline", "red", 2000, 4);
		assertEquals("renault", car.getBrand());
		assertEquals("clio", car.getModel());
		assertEquals(2021, car.getCarYear());
		assertEquals("gasoline", car.getFuelType());
	...
	public void testSedanGetBrand2() {
		RentalFactory rental = new RentalFactory();
		CarFeaturesInterface car = rental.createCar("sedan", "mercedes", "cla", 2021, "gasoline", "red", 2000, 4);
		assertEquals("mercedes", car.getBrand());
		assertEquals("cla", car.getModel());
		assertEquals(2021, car.getCarYear());
		assertEquals("gasoline", car.getFuelType());
	...
	public void testSedanGetBrand3() {
		RentalFactory rental = new RentalFactory();
		CarFeaturesInterface car = rental.createCar("sedan", "mercedes", "GLA", 2022, "gasoline", "red", 2000, 4);
		assertEquals("mercedes", car.getBrand());
	...
	public void testsuvGetBrand() {
		CarFeaturesInterface car = RentalFactory.createCar("suv", "CHERY", "TIGGO7", 2022 ,"GASOLINE", "GRAY", 200, 4);
		assertEquals("CHERY", car.getBrand());
		assertEquals("TIGGO7", car.getModel());
		assertEquals(2022, car.getCarYear());
		assertEquals("GASOLINE", car.getFuelType());
		assertEquals("GRAY", car.getColor());
	...
	public void testsuvGetBrand2() {
		CarFeaturesInterface car = RentalFactory.createCar("suv", "CHERY", "OMODA5", 2022 ,"GASOLINE", "GRAY", 200, 4);
		assertEquals("CHERY", car.getBrand());
	...
	public void testsuvGetBrand3() {
		CarFeaturesInterface car = RentalFactory.createCar("suv", "CHERY", "TIGGO6", 2022 ,"GASOLINE", "GRAY", 200, 4);
		assertEquals("CHERY", car.getBrand());
		assertEquals("TIGGO6", car.getModel());
		assertEquals(2022, car.getCarYear());
		assertEquals("GASOLINE", car.getFuelType());
		assertEquals("GRAY", car.getColor());
		assertEquals(200, car.getPrice());
	...
	public void testStationWagonGetBrand() {
		CarFeaturesInterface car = RentalFactory.createCar("stationwagon", "OPEL", "CORSA", 2007, "GASOLINE", "RED", 200,
				4);
	...
	public void testStationWagonGetBrand2() {
		CarFeaturesInterface car = RentalFactory.createCar("stationwagon", "OPEL", "ASTRA", 2008, "GASOLINE", "RED", 200,
				4);
		assertEquals("OPEL", car.getBrand());
	...
	public void testStationWagonGetBrand3() {
		CarFeaturesInterface car = RentalFactory.createCar("stationwagon", "OPEL", "ASTRA", 2017, "GASOLINE", "RED", 200,
				4);
		assertEquals("OPEL", car.getBrand());
		assertEquals("ASTRA", car.getModel());
	...
	public void testHatchbackGetBrand() {
		CarFeaturesInterface car = RentalFactory.createCar("hatchback", "MERCEDES", "C200", 2005, "GASOLINE", "BLACK", 300,
				4);
		assertEquals("MERCEDES", car.getBrand());
	...
	public void testHatchbackGetBrand2() {
		CarFeaturesInterface car = RentalFactory.createCar("hatchback", "MERCEDES", "C200", 2008, "GASOLINE", "BLACK", 300,
				4);
		assertEquals("MERCEDES", car.getBrand());
		assertEquals("C200", car.getModel());
		assertEquals(2008, car.getCarYear());
	...
	public void testHatchbackGetBrand3() {
		CarFeaturesInterface car = RentalFactory.createCar("hatchback", "MERCEDES", "C200", 2015, "GASOLINE", "BLACK", 300,
				4);
		assertEquals("MERCEDES", car.getBrand());
		assertEquals("C200", car.getModel());
 ...
 */
   ...
   /////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public void testAdminDelete() {
		...
		CarFeaturesInterface car = RentalFactory.createCar("sedan", "SKODA", "OCTAVIA", 2012, "GASOLINE", "GRAY", 967, 4);
	...
	public void testAdminDelete2() {
		...
		CarFeaturesInterface car = RentalFactory.createCar("suv", "ISUZU", "DMAX", 2013, "GASOLINE", "GRAY", 2967, 4);
		shop.rentalCars.add(car);
		shop.INPUT = new Scanner("3\n5\n");
...
;
	...
	public void testMenuController3() {
		...
		CarFeaturesInterface car = RentalFactory.createCar("suv", "CHERY", "OMODA9", 2023, "GASOLINE", "GRAY", 1967 , 4);
